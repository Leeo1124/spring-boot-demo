package com.leeo.common.entity.search.utils;

import com.google.common.collect.Lists;
import com.leeo.common.entity.search.SearchOperator;
import com.leeo.common.entity.search.Searchable;
import com.leeo.common.entity.search.exception.InvalidSearchPropertyException;
import com.leeo.common.entity.search.exception.InvalidSearchValueException;
import com.leeo.common.entity.search.exception.SearchException;
import com.leeo.common.entity.search.filter.AndCondition;
import com.leeo.common.entity.search.filter.Condition;
import com.leeo.common.entity.search.filter.OrCondition;
import com.leeo.common.entity.search.filter.SearchFilter;
import com.leeo.common.utils.SpringUtils;
...
public final class SearchableConvertUtils {
     ...
     * value="com.leeo.ebook.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.leeo.ebook.common.entity.search.utils." +
